from models import vgg_3d_v2, DeepNeuralNetwork
...
save_path = '/groups/heberlein/heberleinlab/Simon/DING_models/vgg_3d_v2/'
with open(save_path+'history_lr1e-3_sgd_batch64_steps100_epochs2000_vgg3d_v2_1.pkl', 'wb') as f:
