...
================================
-run_ImageStack.sh (shell script for temporarily setting environment variables and 
                    executing the application)
   -to run the shell script, type
   
       ./run_ImageStack.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v99, run the shell script as:
       ...
       ./run_ImageStack.sh /mathworks/home/application/v99
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_ImageStack.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure ImageStack.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r ImageStack.zip ImageStack.app
    or the tar command 
    tar -cvf ImageStack.tar ImageStack.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v99/runtime/maci64:MR/v99/sys/os/maci64:MR/v99/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_ImageStack.sh 
